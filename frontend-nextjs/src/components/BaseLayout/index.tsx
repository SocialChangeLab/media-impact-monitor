...
export function BaseLayout({
	...
	return (
		<>
			...
			>
				<div className="relative min-h-[calc(100lvh-var(--headerHeight))]">
					<div
						aria-hidden="true"
						className={cn(
					...
					<div className="min-h-[calc(100lvh-var(--headerHeight))] w-screen max-w-page overflow-x-clip relative">
						{children}
					</div>
				</div>
				<Footer />
