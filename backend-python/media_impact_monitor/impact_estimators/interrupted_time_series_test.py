...
def make_figures():
    ...
    actuals, counterfactuals, impacts = estimate_impacts(events, article_counts)
    ...
    # cumulative_impacts = calculate_cumulative_impacts(events, article_counts)
    # plt.hist(cumulative_impacts)
    # plt.savefig("plots/cumulative_impact.png")
