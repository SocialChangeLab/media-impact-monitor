...
export default function NotFound() {
	return (
		<div className="min-h-[calc(100vh-var(--headerHeight))] flex items-center justify-center">
			<div className="prose w-fit max-w-full p-content">
				<h1 className="mb-6 text-6xl xl:text-8xl font-headlines">404</h1>
				<h2 className="mb-2 mt-0 font-headlines text-3xl xl:text-4xl"> {texts.fourOFour.heading} </h2>
