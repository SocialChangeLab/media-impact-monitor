...
export default function HomePageWithSuspense() {
	return (
		<div
			className={cn(
				'w-full sm:min-h-[calc(100lvh-var(--headerHeight))] bg-brandGreen bg-blend-screen relative z-0',
		...
		>
				...
				<div className="prose max-w-[50ch]">
					<span
						className={cn(
							...
							'flex items-center gap-3 not-prose max-xl:hidden',
						)}
					>
			...
			<div className="w-full h-[50lvh] lg:h-[calc(100lvh-4rem)] relative">
				<Image
